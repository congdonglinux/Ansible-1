...
#Mục lục
- [1. Là gì?Dùng để làm gì?](#khainiem)
- [2. Kiến trúc - Cách hoạt động.](#kientruc)
- [3. Cài đặt](#caidat)
  - [3.1 trên Controller](#controller)
  - [3.2 Trên remote host.](#remotehost)
- [4. Configuration file](#configfile)
  - [4.1 Inventory: /etc/ansible/hosts](#hosts)
  - [4.2 ansible.cfg](#ansible)
- [5. Module](#module)
- [6. Ad-Hoc Commands](#commands)
